...
<div id="wrapper">
    ...
    <!-- per includere del codice da un'altro file è possibile usare include e require, require è usato se il codice che dobbiamo inserire -->
    <!-- è importante per il sito, usando include la pagina rimane navigabile anche se il file esterno non è usabile. -->
